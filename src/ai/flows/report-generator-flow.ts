...
// Prompt para Análisis de Catálogo
...
// Prompt para Análisis de Precios y Márgenes
...
const reportGeneratorFlow = ai.defineFlow(
  ...
  async (input) => {
    ...
    switch (input.reportType) {
        case 'catalog':
            reportGenerator = catalogPrompt;
            title = 'Reporte de Análisis de Catálogo';
            break;
        case 'stock':
            reportGenerator = stockPrompt;
            title = 'Reporte de Análisis de Stock';
            break;
        case 'pricing_margins':
            reportGenerator = pricingMarginsPrompt;
            title = 'Reporte de Precios y Márgenes';
            break;
        default:
            throw new Error(`Invalid report type: ${input.reportType}`);
    }
